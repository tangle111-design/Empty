...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.show_hint = True
        self.error_mastery_tracker = {}  # 用于错误消除机制：记录每个错题被连续做对的次数
        self.initial_error_count = 0     # 记录进入错题模式时的错题总数
    ...
    def create_widgets(self):
        ...
        self.progress_label.pack(side="left", padx=150) # 居中展示大概位置
            ...
            if user_input == self.target_code:
                ...
                if self._is_error_practice_mode:
                    ...
                    if self.error_mastery_tracker[char] >= 2:
                        ...
                        del self.error_mastery_tracker[char] # 移除追踪
    ...
    def change_error_practice_mode(self):
        ...
        if not self._is_error_practice_mode:
            ...
            self.initial_error_count = len(data["error_chars"]) # 记录初始数量
            ...
            self._is_error_practice_mode = False
            self.progress_label.configure(text="") # 退出时清空进度
